          ...
          {currentTab === 'home' && (
            <div className="space-y-6">
              ...
              <div className="axora-home-layout px-3 sm:px-4 max-w-5xl mx-auto space-y-6 lg:grid lg:grid-cols-[280px_minmax(0,1fr)] lg:items-start lg:gap-7 lg:space-y-0">
                ...
                <section className={`hidden rounded-2xl border p-3 lg:block ${cardBg}`} aria-label="Vos raccourcis">
                  <div className="flex items-center justify-between"><div><p className="text-[10px] font-black uppercase tracking-widest text-[#FF2D55]">Votre réseau</p><h2 className="mt-1 text-sm font-black">Comptes suivis</h2></div><button type="button" onClick={() => setCurrentTab('profile')} className="text-[10px] font-bold text-[var(--axo-accent)]">Voir</button></div>
                ...
                <div className="space-y-0 min-w-0 divide-y divide-[var(--axo-border)]">
                  <div className="flex items-center justify-end border-b border-[var(--axo-border)] px-3 py-2"><button type="button" onClick={() => setShowFeedSettings(value => !value)} className="text-[10px] font-bold text-cyan-400">Réglages du fil</button></div>
